...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => { loadUserFromCookies() }, [pathname])
...
const logout = async () => {
  ...
  return (
  <AuthContext.Provider value={{ isAuthenticated: !!token, token, setToken, questions, setQuestions, logout, apiValue, setApiValue}}>
      {children}
